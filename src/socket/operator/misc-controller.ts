...
export default class MiscController extends SocketController {
    constructor(socket: any) {
        ...
        socket.on('markComplaintsReviewed', this.markComplaintsReviewed.bind(this));
    ...
    async markComplaintsReviewed(ids: number[], callback) {
        Complaint.update(ids, { isReviewed: true, reviewTimestamp: new Date() })
        callback(200);
    }
}
